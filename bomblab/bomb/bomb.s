...
bomb:     file format elf64-x86-64 // 对应的汇编
...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numzbers>
...
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp   //开辟80字节空间
  ...
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>    ///BOMB
  ...
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>    ///BOMB
...
0000000000401242 <secret_phase>:
  ...
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax      //把rax存储的值减一然后存储到eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax      //把1000跟eax比较 小于即跳转
